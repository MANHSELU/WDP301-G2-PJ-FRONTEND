...
export default function LichTrinh() {
  ...
  //       setLoading(true);
  //       setError(null);
  //       const response = await fetch("http://localhost:3000/api/customer/notcheck/search");
  //       if (!response.ok) throw new Error("Failed to fetch data");
  //       const data = await response.json();
  //       setTrips(data);
  //     } catch (err: unknown) {
  //       console.log("lỗi trong chương trình là : ", err);
  //       // Khi lỗi, giữ nguyên mock data — không cần reset trips
  //     } finally {
  //       setLoading(false);
  //     }
  //   };
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-orange-50/30 to-slate-100">
                    ...
                    <div className="flex items-center gap-10 relative z-10">
                      <div className="flex items-center gap-6 flex-1 min-w-0">
                        ...
                        <div className="text-orange-600 font-extrabold text-base">
                          {trip?.stop_id?.province}
                        </div>
                      </div>
                      {/* ✅ SỬA: thêm ?.name để hiển thị đúng tên loại xe */}
      ...
      <style>{`
                        .page - enter - nav, .page - enter - copy, .page - enter - bus, .page - enter - search, .page - enter - content {
                          opacity: 0; will-change: transform, opacity; animation-fill-mode: forwards;
                        ...
                        .page-enter-bus {animation - name: page-fade-right; animation-duration: 1.2s; animation-delay: 0.24s; }
                        ...
                        .hero-title-shimmer {
                          color: #ff7a1b; display: inline-block; line-height: 1.12; padding-bottom: 0.14em; margin-bottom: 0;
                        ...
                        background-size: 520px 100%; background-position: 0 50%; background-clip: text;
                        ...
                        transform: scaleX(-1) rotate(-2deg); transform-origin: 50% 50%;
                        ...
                        transform: scaleX(-1) rotate(5deg); transform-origin: 50% 50%;
          ...
          28% {transform: scaleX(-1) rotate(4.1deg) translateY(-1px); }
                        ...
                        @keyframes page-fade-right {0 % { opacity: 0; transform: translateX(34px) scale(0.97); } 100% {opacity: 1; transform: translateX(0) scale(1); } }
          ...
          .page - enter - nav, .page - enter - copy, .page - enter - bus, .page - enter - search,
          .page - enter - content, .hero - title - line, .hero - title - shimmer, .bus - bob,
          .bus - cloud, .bus - tail - cloud, .bus - front - left - passenger,
          .bus - front - left - passenger - img, .bus - driver - fit, .bus - driver - fit - img {
