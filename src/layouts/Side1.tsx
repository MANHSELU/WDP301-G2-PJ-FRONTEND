      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-orange-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-pink-50 rounded-3xl overflow-hidden relative">
            ...
            <div className="relative grid md:grid-cols-2 gap-8 py-10 sm:py-12 md:py-16 items-center">
              {/* Left Side - Content */}
              <div className="flex flex-col justify-center space-y-6 px-6 sm:px-8 md:pl-16 lg:pl-24 pr-6 text-center sm:text-left max-w-[860px] mx-auto md:mx-0 min-w-0">
                {/* Title */}
                <div className="min-w-0">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-3 text-center sm:text-left break-words">
                    Tìm và đặt
                  </h1>
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-3 text-center sm:text-left break-words">
                    ngay chuyến xe
                  </h1>
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 text-center sm:text-left break-words">
              ...
              {/* FORM ĐẶT VÉ */}
              <div className="md:col-span-2 flex justify-center -mt-10 sm:-mt-12 md:-mt-20 mb-12 px-4">
                <div className="w-full max-w-4xl md:max-w-6xl bg-white rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 box-border overflow-hidden min-w-0">
