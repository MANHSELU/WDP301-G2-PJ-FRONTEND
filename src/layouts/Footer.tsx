...
function Footer() {
  return (
    <footer className="bg-gradient-to-b from-[#f29a3b] via-[#ed8b2e] to-[#e97b1f] text-[#fffaf4]">
      <div className="mx-auto max-w-[1240px] px-4 pb-8 pt-12">
        <div className="grid gap-10 text-center sm:text-left md:grid-cols-2 lg:grid-cols-[1.45fr_1fr_1fr_1fr_0.95fr]">
          <div className="space-y-5">
            ...
            <p className="max-w-[280px] text-sm leading-relaxed text-[#fff3e7]/95">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start justify-center gap-3 sm:justify-start">
                ...
                <div>
                  ...
                  <p className="text-[#ffe8d4]/85">Khu đô thị FPT City, Ngũ Hành Sơn</p>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="flex justify-center gap-3 sm:justify-start">
              ...
              <SocialButton icon={<Youtube className="h-4 w-4" />} label="YouTube" />
            </div>
        ...
        <div className="mt-10 border-t border-white/25 pt-5 text-center text-sm text-[#fff2e3]/95 sm:text-left">
...
function SocialButton({ icon, label }: { icon: ReactNode; label: string }) {
  return (
    <a
      href="#"
      aria-label={label}
      className="grid h-9 w-9 place-items-center rounded-lg border border-white/55 bg-white/10 text-[#fffaf4] backdrop-blur transition duration-200 hover:-translate-y-0.5 hover:bg-white hover:text-[#e6781a]"
    >
      {icon}
    </a>
  );
